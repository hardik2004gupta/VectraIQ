...
- Do not expose internal API keys, kubeconfig credentials, or service tokens.
- Do not disclose unreleased infrastructure plans or competitive intelligence.
- Do not recommend unauthorized third-party services outside the approved toolchain.
"""
